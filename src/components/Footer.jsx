...
const Footer = () => {
  return (
    ...
    <p><span className='font-bold'>WeatherLab</span> - Proyecto final de Gauna Agustín, Tecnicatura en Programación - Práctica Profesionalizante.</p>
    

    <div className='flex gap-2'>

        <a href=""><UilGithub/></a>
        <a href=""><UilLinkedin/></a>
